...
abstract class ApiBase
{
    ...
    private $_methods = [
        ...
        'payins_recurring_card-direct_create' => ['/payins/recurring/card/direct', RequestType::POST],
        'payins_recurring_paypal' => ['/payins/payment-methods/paypal/recurring', RequestType::POST],
        'payins_recurring_paypal-web_create' => ['/payins/payment-methods/paypal/recurring', RequestType::POST],
        'payins_recurring_applepay-direct_create' => ['/payins/payment-methods/applepay/recurring', RequestType::POST],
        'payins_recurring_googlepay-direct_create' => ['/payins/payment-methods/googlepay/recurring', RequestType::POST],
    ...
    protected function GetObjectForIdempotencyUrl($url)
    {
        ...
        $map = [
            ...
            'card_validate' => '\MangoPay\CardValidation',
            'client_upload_logo' => '',
            ...
            'disputes_document_create_consult' => '\MangoPay\DocumentPageConsult',
            ...
            'payins_directdebitdirect-direct_create' => '\MangoPay\PayIn',
            ...
            'payins_mbway-web_create' => '\MangoPay\PayIn',
            'payins_multibanco-web_create' => '\MangoPay\PayIn',
            'payins_satispay-web_create' => '\MangoPay\PayIn',
            'payins_blik-web_create' => '\MangoPay\PayIn',
            'payins_klarna-web_create' => '\MangoPay\PayIn',
            'payins_ideal-web_create' => '\MangoPay\PayIn',
            'payins_giropay-web_create' => '\MangoPay\PayIn',
            'payins_bancontact-web_create' => '\MangoPay\PayIn',
            'payins_bizum-web_create' => '\MangoPay\PayIn',
            'payins_swish-web_create' => '\MangoPay\PayIn',
            'payins_twint-web_create' => '\MangoPay\PayIn',
            'payins_paybybank-web_create' => '\MangoPay\PayIn',
            'payins_create_card_pre_authorized_deposit' => '\MangoPay\PayIn',
            'payins_deposit_preauthorized_prior_to_complement' => '\MangoPay\PayIn',
            'payins_deposit_preauthorized_complement' => '\MangoPay\PayIn',
...
//            'payins_recurring_registration' => '\MangoPay\RecurringPayInRegistration', TODO: un-comment after removing legacy code
            ...
            'users_enroll_sca' => '\MangoPay\UserEnrollmentResult',
            'users_manage_consent' => '\MangoPay\UserConsent',
            ...
            'validate_the_format_of_user_data' => '\MangoPay\CompanyNumberDetails',
            'virtual_account_create' => '\MangoPay\VirtualAccount',
            'kyc_documents_create' => '\MangoPay\KycDocument',
            'kyc_page_create' => '',
            'kyc_documents_create_consult' => '\MangoPay\DocumentPageConsult',
            'banking_aliases_iban_create' => '\MangoPay\BankingAliasIBAN',
            'wallets_create' => '\MangoPay\Wallet',
            'users_getemoney_year' => '\MangoPay\EMoney',
            'users_getemoney_month' => '\MangoPay\EMoney',
            'client_create_bank_account_iban' => '\MangoPay\BankAccount',
            'client_create_payout' => '\MangoPay\PayOut',
            'client_create_bank_wire_direct_payin' => '\MangoPay\PayIn',
            ...
            'create_client_wallets_quoted_conversion' => '\MangoPay\Conversion',
